...
<html lang="en">
  <head>
    ...
    <title>Padaria BARBA- Cad Usuario</title>
    <!-- plugins:css -->
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="<?php echo base_url();?>public/css/style.css" <!-- End layout styles -->
    <link rel="shortcut icon" href="<?php echo base_url();?>public/<?php echo base_url();?>public/images/favicon.png" />
  </head>
  <body>
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Novo Usuario</h4>
                <form class="pt-3" method="POST" action="/index.php/login/salvarregistro">
