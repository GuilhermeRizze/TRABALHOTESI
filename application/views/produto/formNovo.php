            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="font-weight-light text-muted mb-0">allenmoreno@gmail.com</p><!--USUARIO LOGADO - ALTERAR VARIAVEL-->
                </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="perecivel" required>
                          <option>Sim</option>
                          <option>Não</option>
                        </select>
                      </div>
               ...
               <!--         <div class="input-group col-xs-12">
                          ...
                          <span class="input-group-append">
                            ...
                            VERIFICAR O PORQUE DE NÃ ESTAR APARECENDO PARA SELECIONAR ARQUIVO
                          </span>
                        </div>
                      </div> --->
